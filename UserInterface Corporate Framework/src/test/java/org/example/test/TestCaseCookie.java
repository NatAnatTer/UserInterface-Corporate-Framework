...
public class TestCaseCookie extends BaseTest {
    ...
    public void cookieAcceptTest() {
        ...
        logger.info("Проверка: диалоговое окно cookie закрылось при нажатии на кнопку принять");
        Assert.assertFalse(registrationPage.cookiesAccept(), "Диалоговое окно cookie не скрыто");
    }
}
